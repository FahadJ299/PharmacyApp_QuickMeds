...
class PharmacyListActivity : AppCompatActivity(), AdapterItem.ListItemClickListener, AdapterItem.CheckboxClickListener {
    ...
    override fun onCheckboxClick(position: Int, isChecked: Boolean) {
        if (isChecked) {
          ...
          //  val selectedItem: ItemHelper = adapterItem.getItem(position)
