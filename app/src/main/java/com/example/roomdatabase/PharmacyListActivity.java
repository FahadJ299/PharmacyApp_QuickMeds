...
public class PharmacyListActivity extends AppCompatActivity implements AdapterItem.ListItemClickListener, AdapterItem.CheckboxClickListener {
    ...
    public void onCheckboxClick(int position, boolean isChecked) {
        if (isChecked) {
            ...
            ItemHelper selectedItem = adapterItem.getItem(position);
